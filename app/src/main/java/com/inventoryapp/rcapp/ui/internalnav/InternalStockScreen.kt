...
//    val productList = internalProductViewModel?.productList
    val internalProduct by internalProductViewModel!!.internalProducts.observeAsState()


//    val internalProductResource = internalProductViewModel?.fetchProductList()
...
//                    }
//                }
//                if (internalProductViewModel!!.fetchEventList.isInitialized) {
//                    // Show a loading indicator while data is being fetched
//                    CircularProgressIndicator(modifier = Modifier.align(Alignment.CenterHorizontally))
//                } else if (internalProductViewModel.fetchEventList.observeAsState() is Resource.Success<*>) {
//                    val productList =
//                        (internalProductViewModel.fetchEventList.value as Resource.Success<List<InternalProduct>>).result                    // Display the list of products using composables
//                    LazyColumn (modifier = Modifier.padding(start = 8.dp, end = 8.dp, top =25.dp, bottom = 80.dp)){
...
//                        }
//                    }
//                } else if (internalProductViewModel.productData.value is Resource.Failure) {
...
//                            } else {
                                ...
                                Toast.makeText(context,"Sukses menambahkan barang",Toast.LENGTH_SHORT).show()
